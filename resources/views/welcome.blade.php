    ...
    <body class="bg-gradient-to-b from-white to-yellow-50 font-sans">
        ...
        <nav class="flex items-center justify-between px-8 py-4 bg-black-50 custom-shadow">
            <div class="flex items-center space-x-4">
                ...
                <a href="#" class="text-sm font-medium text-white-700 hover:text-orange-500">Pencatatan
                    Posyandu</a>
            </div>
      ...
      Jelajahi Fitur
        ...
        <section class="relative h-screen w-full overflow-hidden">
            ...
            <div id="heroCarousel" class="carousel slide h-full" data-bs-ride="carousel">
                <div class="carousel-inner h-full">
                    <div class="carousel-item active h-full">
                        <img src="{{ asset('images/image2.png') }}" class="d-block w-full h-full object-cover"
                            alt="Slide 1">
                    </div>
                    <div class="carousel-item h-full">
                        <img src="{{ asset('images/image4.png') }}" class="d-block w-full h-full object-cover"
                            alt="Slide 2">
                    </div>
                    <div class="carousel-item h-full">
                        <img src="{{ asset('images/image5.png') }}" class="d-block w-full h-full object-cover"
                            alt="Slide 3">
                    </div>
                </div>
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10 bg-black/30">
                ...
                <h2 class="text-lg md:text-xl font-semibold text-orange-100 mb-3">Sistem Informasi Geografis Anak Sehat
                    Indonesia</h2>
                <p class="text-white max-w-2xl text-sm md:text-base leading-relaxed">
                    Platform Geographic Information System (GIS) berbasis web yang dirancang khusus untuk mendukung
                    pencatatan dan pemantauan aktivitas posyandu terpadu di Provinsi Jawa Tengah.
                </p>
            </div>
        </section>
        ...
        <section class="px-8 py-16 bg-gradient-to-b from-white to-yellow-50">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full md:w-2/3">
                    ...
                    <!-- Card 1 -->
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 hover:shadow-xl"
                        data-aos="zoom-in-up" data-aos-delay="100">
                        <img src="{{ asset('images/dashboard2.png') }}" class="w-full h-40 object-cover rounded-md mb-4"
                            alt="Pencatatan Posyandu">
                        ...
                        <a href="#"
                            class="inline-block bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-600">Dashboard</a>
                    </div>

                    <!-- Card 2 -->
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 hover:shadow-xl"
                        data-aos="zoom-in-up" data-aos-delay="200">
                        <img src="{{ asset('images/jateng.png') }}" class="w-full h-40 object-cover rounded-md mb-4"
                            alt="Peta Persebaran">
                        <h3 class="text-xl font-semibold text-orange-600 mb-2">Peta Persebaran Stunting</h3>
                        <p class="text-sm text-gray-600 mb-4">Pantau data stunting di setiap daerah lewat peta
                            interaktif.</p>
                        <a href="#"
                            class="inline-block bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-600">WEBGIS</a>
                    </div>
        ...
        <section class="py-10">
            <div class="bg-white p-4 rounded-lg shadow-md">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    <!-- Card 1 -->
                    <div
                        class="bg-white border-2 border-yellow-200 rounded-2xl shadow-md p-6 w-60 hover:-translate-y-1 transition">
        ...
        <section class="py-12">
            <div class="max-w-5xl mx-auto px-4 text-center">
                ...
                <div
                    class="aspect-video rounded-xl overflow-hidden shadow-lg border-4 border-orange-200 mx-auto hover:scale-105 transition duration-300">
                    <iframe class="w-full h-full" src="https://www.youtube.com/embed/UTiD4g0ncuQ"
                ...
                <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">
                            Sistem Informasi Geografis Anak Sehat Indonesia adalah platform pemantauan posyandu dan
                            stunting berbasis GIS di Jawa Tengah.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm">Email: <a href="mailto:support@sigasi.id"
                                class="text-orange-700 hover:underline">support@sigasi.id</a></p>
                        <p class="text-sm">Telepon: 0856-xxxx-xxxx</p>
                        <div class="flex space-x-4 mt-3">
                            <a href="#" class="text-orange-700 hover:text-orange-900"><i
